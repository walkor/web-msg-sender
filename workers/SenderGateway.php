...
require_once WORKERMAN_ROOT_DIR . 'applications/Sender/Protocols/GatewayProtocol.php';
require_once WORKERMAN_ROOT_DIR . 'applications/Sender/Store.php';

class SenderGateway extends Man\Core\SocketWorker
{
    /**
     * 内部通信socket
     * @var resouce
